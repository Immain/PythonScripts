...
# Version: 1.0.0
# Description: Downloads playlists from youtube and saves it as a mp4 file with the thumbnail as a jpg file in the same$
import pafy, re, wget, os, ffmpeg, pytube

url = "https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=PLetg744TF10BrdPjaEXf4EsJ1wz6fyf95"
...
for video in playlist.videos:
    ...
    filestream = f"{videoTitleResult}.mp4"
